...
**Data Science student @ UC San Diego** · seeking internships in ML / data engineering.

I build practical, production-minded systems around **LLMs, retrieval (RAG), evaluation, and data pipelines** — with tests, CI, and clear docs, not just notebooks.
